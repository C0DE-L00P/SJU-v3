...
const filterReq = debounce(() => Inertia.get(route('admin.explainer.index'), appended.value, { preserveState: true, replace: true }), 500);
watch(
...
const sortBy = (column) => {
    ...
    Inertia.get(route('admin.explainer.index'), appended.value, { preserveState: true, replace: true });
};
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header border-bottom">
                <h5 class="card-title mb-3">{{ __('Candidates') }}</h5>
            </div>
                    ...
                    <div class="col-md-10 mb-1">
                        <div
                            ...
                            <div class="dt-buttons">
                                <Link v-if="files.can_create" :href="route('admin.explainer.create')" type="button"
