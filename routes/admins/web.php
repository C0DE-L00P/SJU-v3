...
use App\Http\Controllers\Admin\ExplainerController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::middleware('auth:admin')->group(function () {
         ...
         * Training bags
         */
        Route::get('explainer', [ExplainerController::class, 'index'])->name('explainer.index');
        Route::get('explainer/create', [ExplainerController::class, 'create'])->name('explainer.create');
        Route::post('explainer', [ExplainerController::class, 'store'])->name('explainer.store');
        Route::delete('explainer/{file}', [ExplainerController::class, 'destroy'])->name('explainer.destroy');
